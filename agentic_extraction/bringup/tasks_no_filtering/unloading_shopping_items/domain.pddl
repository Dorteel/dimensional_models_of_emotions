...
(:action push
    :parameters (?r - robot ?o - locatable ?from - location ?to - location)
    :precondition
        (and
            (at ?r ?from)
            (at ?o ?from)
...
(:action pour
    :parameters (?r - robot ?source - item ?target - item ?l - location)
    :precondition
        (and
            (at ?r ?l)
            (at ?source ?l)
...
(:action clean
    :parameters (?r - robot ?o - locatable ?tool - item ?l - location)
    :precondition
        (and
            (at ?r ?l)
            (at ?o ?l)
