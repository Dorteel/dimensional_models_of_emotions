...
(:action place_in_container
    :parameters (?r - robot ?o - item ?c - item ?l - location)
    :precondition
        (and
            (at ?r ?l)
            (holding ?r ?o)
...
(:action open
    :parameters (?r - robot ?o - device ?l - location)
    :precondition
        (and
            (at ?r ?l)
            (at ?o ?l)
...
(:action pour
    :parameters (?r - robot ?a - item ?b - locatable ?l - location)
    :precondition
        (and
            (at ?r ?l)
            (holding ?r ?a)
...
(:action clean
    :parameters (?r - robot ?v - vacuum ?d - dust ?l - location)
    :precondition
        (and
            (at ?r ?l)
            (at ?v ?l)
